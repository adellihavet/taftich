    ...
    return (
        <div className="h-full flex flex-col md:flex-row bg-slate-50 overflow-hidden">
            ...
            <div className="w-full md:w-80 bg-white border-l border-slate-200 flex flex-col h-full overflow-y-auto print:hidden shadow-lg z-10">
                ...
                <div className="p-5 space-y-6 flex-1">
                    ...
                    <div className="space-y-2">
                        ...
                        {traineeTeachers.length > 0 ? (
                            <div className="space-y-2">
                                {traineeTeachers.map(t => (
                                    <div 
                                        ...
                                        className={`p-3 rounded-xl border cursor-pointer transition-all flex items-center gap-3 ${selectedTeacherId === t.id ? 'bg-indigo-50 border-indigo-500 ring-1 ring-indigo-500' : 'bg-white border-slate-200 hover:bg-slate-50'}`}
                                    >
                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${selectedTeacherId === t.id ? 'bg-indigo-200 text-indigo-700' : 'bg-slate-100 text-slate-500'}`}>
                                            <User size={16} />
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-bold text-slate-800 truncate">{t.fullName}</p>
                                            <p className="text-[10px] text-slate-500 truncate flex items-center gap-1">
                                                <School size={10} /> {t.schoolName}
                                            </p>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="text-center py-8 bg-slate-50 rounded-xl border border-dashed border-slate-300 text-slate-400 text-xs">
                                لا يوجد أساتذة متربصون في القائمة
                            </div>
                        )}
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <VoiceInput 
                            label="المرجع (قرار التأهيل)" 
                            placeholder="مثلاً: القرار رقم ... بتاريخ ..." 
                            value={reference} 
                    ...
                    <div className="space-y-2">
                        ...
                        <VoiceTextarea 
                            ...
                            className="w-full p-3 border rounded-xl text-xs leading-relaxed min-h-[120px] resize-none focus:ring-2 focus:ring-indigo-500 outline-none"
                        />
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full bg-indigo-600 text-white py-3 rounded-xl font-bold shadow-lg hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-auto"
                    >
                        <Printer size={18} />
                        طباعة الإشعار
                    </button>
            ...
            <div className="flex-1 bg-slate-100 p-8 overflow-y-auto flex justify-center items-start">
                ...
                {/* A4 Paper - Reduced padding from 20mm to 15mm to save vertical space */}
                <div className="bg-white shadow-2xl w-[210mm] min-h-[297mm] p-[15mm] relative text-black font-serif print:w-full print:h-full print:shadow-none print:m-0 flex flex-col">
                    ...
                    <div className="flex-1 px-4">
                        ...
                        {/* Recipient - Adjusted spacing and removed line breaks in labels */}
                        <div className="mb-8 text-base leading-relaxed font-bold">
                        ...
                        {/* Subject & Reference - Compact padding */}
                        <div className="mb-6 border border-black p-3 rounded-lg">
                        ...
                        {/* Body Text - Reduced line height and font size slightly */}
                        <div className="mb-8 text-justify text-base leading-loose font-medium indent-8">
                        ...
                        {/* Signature - Removed placeholder text/border */}
                        <div className="flex justify-between items-start mt-auto pt-4">
                            ...
                            <div className="text-center w-1/3">
                                ...
                                {/* Removed the text (الختم والتوقيع) and border, kept the space */}
